...
/**
 * Options parser that follows SparkStreamingParser's specific options-parsing needs.
 * <ul>
...
public class SparkStreamingParser extends GnuParser {

    public static final Log LOG = LogFactory.getLog(SparkStreamingParser.class.getName());
